...
<html lang="en">
            ...
            <tbody>
                <tr>
                    ...
                    {{--  @if($invoice->status)
                        ...
                        @endif
                    --}}
                        <p>{{ __('invoices::invoice.Order') }}: <strong>{{ $invoice->getSerialNumber() }}</strong></p>
 ...
 -->
        ...
        <table class="table table-items">
            <thead>
                <tr>
                    <th scope="col" class="border-0 pl-0">{{ __('invoices::invoice.item_name') }}</th>
